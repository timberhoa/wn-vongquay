                      ...
                      <img style="max-height:150px" id="logo_url_preview" src="
                        ...
                        <div class="row form-group">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-md-8">
                              <input name="Ftitle" value="<?php echo trim($spinio_fdata['Ftitle']); ?>" type="text" placeholder="*Điều khoản trò chơi" class="form-control input-md">
                              </div>
                            </div>
                            <div class="row form-group">
                              <label class="col-md-2 control-label">Short Description</label>
                              <div class="col-md-8">
                                <input name="Fdescription" value="<?php echo trim($spinio_fdata['Fdescription']); ?>" type="text" placeholder="Nhập email để thử vận may." class="form-control input-md">
                                </div>
                              </div>
                              <div class="row form-group">
